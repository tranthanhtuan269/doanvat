    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Tạo trang cửa hàng</div>
                <div class="panel-body">
                    ...
                    {!! Form::open(['url' => '/shop/store', 'class' => 'form-horizontal', 'files' => true, 'id' => 'create-shop']) !!}

                    <div class="form-group {{ $errors->has('banner') ? 'has-error' : ''}}">

                        <div class="col-md-12">
                            <input type="hidden" id="banner" name="banner" value="">
                            <img src="{{ url('/') }}/public/images/banner.jpg" id="banner-image" class="img" style="height: 160px; width: 100%; background-color: #fff; border: 2px solid gray; border-radius: 5px;">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group {{ $errors->has('logo') ? 'has-error' : ''}}">
                                <div class="col-md-12">
                                    ...
                                    <img src="{{ url('/') }}/public/images/logo.jpg" id="logo-image" class="img" style="height: 150px; width: 150px; background-color: #fff; border: 2px solid gray; border-radius: 5px;">
                        ...
                        <div class="col-md-10">
                            <div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
                                <div class="col-md-12">
                                    {!! Form::text('name', null, ['class' => 'form-control', 'id' => 'shop-name', 'placeholder' => 'Tên nhà tuyển dụng']) !!}
